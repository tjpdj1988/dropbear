...
INSTALL=install
CPPFLAGS=
CFLAGS+=-I. -I$(srcdir) $(CPPFLAGS) --sysroot=/opt/android-ndk-r10e/platforms/android-17/arch-arm/
LIBS+=
LDFLAGS=--sysroot=/opt/android-ndk-r10e/platforms/android-17/arch-arm/
